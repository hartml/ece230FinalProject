...
#define RGB_PORT                                            P2 //Make P5 for the actual project. But we need to setup the current limiting resistors for the LED's
#define RGB_RED_PIN                                         (BIT4)
#define RGB_YELLOW_PIN                                      (BIT5)
#define RGB_GREEN_PIN                                       (BIT6)
#define RGB_BLUE_PIN                                        (BIT7)
#define RGB_ALL_PINS                                        (BIT4 | BIT5 | BIT6 | BIT7)
 ...
 *
 * Modified bit 3 of \b P2OUT register.
 *
 * \return None
 */
 ...
 *
 * Modified bit 4 of \b P2OUT register.
 *
 * \return None
 */
 ...
 * \return None
 */
extern void RGBLED_toggleYellow(void);
